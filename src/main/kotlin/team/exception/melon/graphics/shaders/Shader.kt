...
import team.exception.melon.graphics.GLObject

open class Shader(vertShaderId: MelonIdentifier, fragShaderId: MelonIdentifier) : GLObject, Helper {
    ...
    private fun createShader(id: MelonIdentifier, shaderType: Int): Int {
        RenderSystem.assertOnRenderThread()
