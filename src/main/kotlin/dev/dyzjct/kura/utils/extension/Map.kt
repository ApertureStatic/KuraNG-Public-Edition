...
fun <K, V> NavigableMap<K, V>.lastValueOrNull(): V? = this.lastEntry()?.value

fun <K, V> NavigableMap<K, V>.firstValueOrNull(): V? = this.firstEntryOrNull()?.value

fun <K, V> NavigableMap<K, V>.firstEntryOrNull(): MutableMap.MutableEntry<K, V>? = firstEntry()

fun <K, V> NavigableMap<K, V>.lastEntryOrNull(): MutableMap.MutableEntry<K, V>? = lastEntry()
