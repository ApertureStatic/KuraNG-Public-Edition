...
inline fun <E> MutableSet<E>.synchronized(): MutableSet<E> = Collections.synchronizedSet(this)

inline fun <E> SortedSet<E>.synchronized(): SortedSet<E> = Collections.synchronizedSortedSet(this)
