...
open class BreakInfo(
    ...
    class Mutable : BreakInfo(DUMMY_CRYSTAL, Float.MAX_VALUE, AutoCrystal.forcePlaceDmg.value) {
        ...
        fun clear() {
            update(DUMMY_CRYSTAL, Float.MAX_VALUE, AutoCrystal.forcePlaceDmg.value)
        }
    }
