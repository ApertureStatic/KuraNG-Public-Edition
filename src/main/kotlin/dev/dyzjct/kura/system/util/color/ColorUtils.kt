...
object ColorUtils {
    ...
    fun getBrightness(colorToDarker: Color, bright: Float): Color {
        val hsv = Color.RGBtoHSB(colorToDarker.red, colorToDarker.green, colorToDarker.blue, null)
        return Color(Color.HSBtoRGB(hsv[0], hsv[1], bright))
    }
