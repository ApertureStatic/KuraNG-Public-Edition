...
import melon.events.*
import melon.events.entity.EntityEvent
import melon.system.event.*
import melon.utils.TickTimer
import melon.utils.combat.CalcContext
import melon.utils.combat.CrystalUtils.canPlaceCrystal
import melon.utils.combat.DamageReduction
import melon.utils.combat.MotionTracker
import melon.utils.concurrent.threads.defaultScope
import melon.utils.concurrent.threads.isActiveOrFalse
...
object CombatManager : AlwaysListening {
    ...
    private fun SafeClientEvent.updateCrystalDamage() {
        ...
        if (flag1 || flag2) {
            val predictPosSelf = trackerSelf?.calcPosAhead(MelonAura2.ownPredictTicks.value) ?: player.pos
